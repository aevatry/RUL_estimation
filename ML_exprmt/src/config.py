...
class Config:
    def __init__(self) -> None:
        ...
        self.config_path = filedialog.askopenfilename (initialdir=os.getcwd(), filetypes=[('JSON File', '*.json')])
...
class Config_remote:
    def __init__(self, config_path:str, train_dir:str, eval_dir:str) -> None:
